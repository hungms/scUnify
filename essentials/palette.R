...
royal1_4 <- wesanderson::wes_palette("Royal1") 
asteroid3_5 <- wesanderson::wes_palette("AsteroidCity3")
darjeeling2_5 <- wesanderson::wes_palette("Darjeeling2")
zissou1_5 <- wesanderson::wes_palette("Zissou1")
...
calc <- c("#004586", "#FF420E", "#FFD320", "#579D1C", "#7E0021", "#83CAFF", "#314004", "#AECF00", "#4B1F6F", "C5000B", "#0084D1")
